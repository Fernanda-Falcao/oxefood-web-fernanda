...
export default function FormVenda() {
  ...
  const handleChangeRadio = (e, { value }) => {setRetiradaEmLoja(value);
  };
 const venda = [
    {
    ...
    { key: "Pago", text: "Pago", value: "Pago" },{ key: "Entregue", text: "Entregue", value: "Entregue" },];
 
 const handleChange = (e, { value }) => {setStatusVenda(value);
     ...
     if (idVenda != null) { //Alteração:
       axios.put("http://localhost:8080/api/venda/" + idVenda, vendaRequest)
        ...
        .then((response) => { console.log("Venda cadastrada com sucesso.") })
         .catch((error) => {console.log("Erro ao incluir venda")})
